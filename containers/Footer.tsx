...
export function Footer() {
  ...
  return (
    <footer className="h-full w-full pt-4 pb-16">
      <Container>
        <div className="flex items-center justify-between px-2 lg:px-0">
          ...
          <div className="flex space-x-8">
            ...
            <a
              className="text-red hover:text-green rounded-sm"
            ...
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 455 455"
                fill="currentColor" // Use currentColor for flexible styling via CSS
                width="56"
                height="56"
              >
                <g>
